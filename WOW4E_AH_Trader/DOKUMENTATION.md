...
Alle AHT-Fenster verwenden einen vollständig schwarzen, undurchsichtigen Hintergrund. Das Rezept-/Materialfenster ist ein eigenes verschiebbares `UIParent`-Fenster. Es bleibt beim Schließen des AH mit den zuletzt geladenen Listings sichtbar; Live-Scans und Käufe werden bis zum erneuten Öffnen des AH pausiert.
