...
> Status: Beta-Port für Interface `16001` / Version `0.6.9-beta`. Rezept-, Commodity-Kauf- und Post-Events müssen weiterhin im echten Forever-Client verifiziert werden.
