...
> Status: Beta-Port für Interface `16001` / Version `0.2.0-beta`. Rezept-, Commodity-Kauf- und Post-Events müssen weiterhin im echten Forever-Client verifiziert werden.
